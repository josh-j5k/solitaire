...
>
	<nav class="flex flex-col items-center gap-8">
		...
		<button onclick={startGame} class="flex gap-4 items-center group">
			<span>
				<svg
					viewBox="0 0 32 32"
					version="1.1"
					...
					class="w-10 h-10 -lg:w-6 -lg:h-6 group-hover:scale-90 transition-transform"
					fill="#000000"
					><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
						id="SVGRepo_tracerCarrier"
						stroke-linecap="round"
			...
			<span
				class="capitalize text-3xl -lg:text-2xl font-bold text-white group-hover:text-[#00a3f5]"
				>new game</span
			>
		</button>
		<button onclick={pauseAndPlayGame} class=" flex gap-4 items-center group">
			<span>
				{#if store.pause}
					<svg
						viewBox="0 0 24 24"
						fill="none"
						class="w-10 h-10 -lg:h-6 -lg:w-6 group-hover:scale-90 transition-transform"
						xmlns="http://www.w3.org/2000/svg"
						><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g
							id="SVGRepo_tracerCarrier"
							stroke-linecap="round"
		...
		<div class="relative">
			<button onclick={toggleDropdown} class="flex gap-4 items-center group">
				<span>
					<svg
						class="w-10 h-10 -lg:h-6 -lg:w-6 group-hover:scale-90 transition-transform"
						fill="#00a3f5"
			...
			{#if dropdown}
				<div
					class="bg-black/70 absolute translate-x-[110%] top-0 w-11/12 p-8 z-30 shadow"
				>
					<ul class="flex flex-col items-center gap-3 text-3xl -lg:text-2xl">
						<button
		...
		<button onclick={leaderboard} class=" flex gap-4 items-center group">
			<span>
				<svg
					class="w-10 h-10 -lg:h-6 -lg:w-6 group-hover:scale-90 transition-transform"
					viewBox="0 0 24 24"
		...
		<button onclick={help} class=" flex gap-4 items-center group">
			<span>
				<svg
					class="w-10 h-10 -lg:h-6 -lg:w-6 group-hover:scale-90 transition-transform"
					version="1.1"
